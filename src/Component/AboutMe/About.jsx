...
const About = () => {
  return (
    ...
    className='about'>
      ...
      <p > 
        My name is Prashanna Maharjan, and I am an enthusiastic Computer Science graduate at Taylor’s University. I have a strong interest in frontend development, with growing expertise in React and modern web technologies. Alongside programming, I have developed skills in UI/UX design, where I focus on creating user-friendly and visually appealing interfaces.
